...
struct AcCmdCLLeaveGuildParty
{
  // Empty

  static Command GetCommand()
  {
    return Command::AcCmdCLLeaveGuildParty;
  }
  ...
  //! @param stream Sink stream.
  static void Write(
    const AcCmdCLLeaveGuildParty& command,
    SinkStream& stream);
  ...
  //! @param stream Source stream.
  static void Read(
    AcCmdCLLeaveGuildParty& command,
    SourceStream& stream);
};

struct AcCmdCLLeaveGuildPartyOK
{
  // Empty

  static Command GetCommand()
  {
    return Command::AcCmdCLLeaveGuildPartyOK;
  }
  ...
  //! @param stream Sink stream.
  static void Write(
    const AcCmdCLLeaveGuildPartyOK& command,
    SinkStream& stream);
  ...
  //! @param stream Source stream.
  static void Read(
    AcCmdCLLeaveGuildPartyOK& command,
    SourceStream& stream);
};

struct AcCmdCLLeaveGuildPartyNotify
{
  //! The character uid of the character leaving.
  uint32_t leaverCharacterUid{};
  //! The character uid of the new party leader.
  uint32_t leaderCharacterUid{};

  static Command GetCommand()
  {
    return Command::AcCmdCLLeaveGuildPartyNotify;
  }
  ...
  //! @param stream Source stream.
  static void Read(
    AcCmdCLLeaveGuildPartyNotify& command,
    SourceStream& stream);
};
