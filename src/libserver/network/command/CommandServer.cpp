...
bool IsMuted(protocol::Command id)
{
  return id == protocol::Command::AcCmdCLHeartbeat
    ...
    || id == protocol::Command::AcCmdCRHurdleClearResult
    || id == protocol::Command::AcCmdCRHurdleClearResultOK
    || id == protocol::Command::AcCmdCRRequestSpur
    || id == protocol::Command::AcCmdCRRequestSpurOK;
}
